...
public abstract class OverlayManager implements OnMarkerClickListener, OnPolylineClickListener {
    ...
    public List<OverlayOptions> getmOverlayOptionList() {
        return mOverlayOptionList;
    }

    public void setmOverlayOptionList(List<OverlayOptions> mOverlayOptionList) {
        this.mOverlayOptionList = mOverlayOptionList;
    }
